...
public enum Role {
	...
	PROFESSOR(Stream.of(Permission.PROFESSOR_PERMISSIONS, Permission.USER_PERMISSIONS).flatMap(Set::stream)
			.collect(Collectors.toSet())),

	ADMIN(Stream.of(Permission.USER_PERMISSIONS, Permission.PROFESSOR_PERMISSIONS, Permission.ADMIN_PERMISSIONS)
